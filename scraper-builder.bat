...
python seraphim-weekend-scraper.py --stores-file "Stores.txt" --output "matches.fresh.json" --stores-file "Stores - fatpack.txt" --output "matches - fatpack.fresh.json" --stores-file "Stores - build.txt" --output "matches - build.fresh.json" --events-file "Events.txt" --events-output "matches - events.fresh.json"
